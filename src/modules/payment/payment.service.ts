...
export class PaymentService {
  ...
  constructor(
    ...
    @Inject(PAYMENT_STATUSES_REPOSITORY) readonly paymentStatusesRepository: typeof PaymentStatus,
    @Inject(PAYMENT_TYPES_REPOSITORY) readonly paymentTypesRepository: typeof PaymentType,
      ...
      if (carInDB) {
        try {
          await this.sequelize.transaction(async t => {
            ...
            let couponCode = (createPaymentDto.coupon_code) ? createPaymentDto.coupon_code : "";
